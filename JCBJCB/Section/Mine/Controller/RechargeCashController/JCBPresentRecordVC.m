...
@interface JCBPresentRecordVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation JCBPresentRecordVC
...
- (void)loadNewDataSourse {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@/rest/cashList?pageNumber=%ld&pageSize=10", SGCommonURL, self.firstPageNumber];
    ...
    [SGHttpTool getAll:urlStr params:nil success:^(id dictionary) {
        ...
        self.dataSource_mArr = [JCBRechargeCashModel mj_objectArrayWithKeyValuesArray:dictionary[@"userCashList"]];
...
- (void)loadMoreDataSourse {
    ...
    [SGHttpTool getAll:urlStr params:nil success:^(id json) {
        ...
        NSArray *moreDataSource = [JCBRechargeCashModel mj_objectArrayWithKeyValuesArray:json[@"userCashList"]];

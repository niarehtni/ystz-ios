...
@implementation JCBRechargeCashVC
...
- (void)setupSubviews {
    ...
    // 添加标题
    NSArray *login_register_arr = @[@"充值", @"提现"];
...
- (void)setupChildViewController {
    // JCBRechargeVC
    JCBRechargeVC *rechargeVC = [[JCBRechargeVC alloc] init];
    [self addChildViewController:rechargeVC];
    
    // JCBWithdrawCashVC
    JCBWithdrawCashVC *cashVC = [[JCBWithdrawCashVC alloc] init];
